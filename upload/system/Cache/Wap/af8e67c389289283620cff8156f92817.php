		...
		<div id="container">
			<div id="scroller">
				...
				<header <?php if($config['many_city']): ?>class="hasManyCity"<?php endif; ?>>
					<?php if($config['many_city']): ?><div id="cityBtn" class="link-url" data-url="<?php echo U('Changecity/index');?>"><?php echo ($config["now_select_city"]["area_name"]); ?></div><?php endif; ?>
				...
				<?php if($config['house_open']): ?><section class="invote index_house" style="margin-top:10px;">
