	    ...
	    <div class="component-login-section component-login-section--page mt-component--booted" >
		    <div class="origin-part theme--www">
		        ...
		        <form id="J-login-form" method="post" class="form form--stack J-wwwtracker-form">
					...
					<?php if(C('config.reg_verify_sms') AND C('config.sms_key')): ?><div class="form-field form-field--icon">
			            <i class="icon icon-user"></i>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#J-login-form").submit(function(){
				...
				<?php if(C('config.reg_verify_sms') AND C('config.sms_key')): ?>var sms_code = $("#sms_code").val();<?php endif; ?>
				...
				$.post("<?php echo U('Index/Login/reg');?>", {'phone':phone,'pwd':pwd <?php if(C('config.reg_verify_sms') AND C('config.sms_key')): ?>,sms_code:sms_code<?php endif; ?>}, function(data){
					if(data.error_code){
