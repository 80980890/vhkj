 ...
 var  meal_alias_name = "<?php echo ($config["meal_alias_name"]); ?>";
	...
	<div class="mainbox">
		...
		<?php if($system_session['level'] == 2): ?><div id="system"  class="list">
			...
			<ul id="official_news">
			<li>程序当前版本 :<?php echo $ver;?>&nbsp;&nbsp;&nbsp;
			<font color="red"> 
			<?php
 $version = './conf/version.php'; $ver = include $version; $ver = $ver['release']; $hosturl = urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['PHP_SELF']); $updatehost = 'http://o2o-service.idz.pw/update.php'; $lastver = file_get_contents(($updatehost . '?a=check&v=') . $release); if($lastver !== $release){ echo "主人，又有更新啦&nbsp;&nbsp;&nbsp;&nbsp;<a href='/admin.php?g=System&c=Update&a=index'><font color=green;font-weight:bold>在线更新</font></a>"; }else{ echo '!^_^  已经是最新系统 不需要升级'; } ?>
			
			
			</font>  
			<li><a href="www.idz.pw" class="hideSxBtn" style="color:#CC3366;font-weight:bold;"><?php echo $vertime;?></a></li>
			<li><a href="http://www.pigcms.com" target="_blank" style="color:green;">庆祝 O2O程序 2.21版本上线</a></li>
			<li><a href="http://www.pigcms.com" target="_blank" style="color:red;" se_prerender_url="complete">新年伊始 小猪CMS竭诚为您服务</a></li>
			<li><a href="http://www.pigcms.com" target="_blank" style="color:blue;">2016，小猪CMS 感谢有你！</a></li>
			<li><a href="http://www.pigcms.com/2016/notice_0116/4414.html" target="_blank" style="color:green;">小猪CMS全体员工给大家拜年啦</a></li>
			</ul>
