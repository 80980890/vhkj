								...
								<div style="border:1px solid #c5d0dc;padding-left:22px;margin-bottom:10px;" id="cue_html_tips">
									<table class="table table-striped">
										<tbody>
											...
											<?php $__FOR_START_1161357258__=1;$__FOR_END_1161357258__=10;for($i=$__FOR_START_1161357258__;$i < $__FOR_END_1161357258__;$i+=1){ ?><tr class="parent" data-index="<?php echo ($i); ?>">
