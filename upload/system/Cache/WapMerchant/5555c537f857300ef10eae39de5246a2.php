	...
	<form class="pigcms-form" method="post" action="" onsubmit="return checkSubmit();return false;">
	  ...
	  <div class="pigcms-container">
			...
			<span class="verify_box">
				<img src="<?php echo U('Index/verify',array('type'=>'reg'));?>" id="reg_verifyImg" onclick="reg_fleshVerify('<?php echo U('Index/verify',array('type'=>'reg'));?>')" title="刷新验证码" alt="刷新验证码" style="vertical-align: middle;"/>&nbsp;
				<a href="javascript:reg_fleshVerify('<?php echo U('Index/verify',array('type'=>'reg'));?>')">刷新验证码</a>
			</span>
		</div>
